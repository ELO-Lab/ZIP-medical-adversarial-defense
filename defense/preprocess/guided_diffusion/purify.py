...
class ConcatDataset(Dataset):
    def __init__(self, dataset, args, transform=None):
        ...
        # self.data = DataLoader(self.dataset, batch_size=args.batch_size, shuffle=True)
        self.transform = transform
        self.number_in_image = (IMG_SIZE//args.img_size)*(IMG_SIZE//args.img_size)
        print("img_size",args.img_size)
        print(f"({IMG_SIZE}//args.img_size)", (IMG_SIZE//args.img_size))
        ...
        for clean_class_label in self.classes:
            ...
            for pois_class_label in self.classes:
                ...
                # print('zzz', num_concat_images, num_images, self.number_in_image)
        ...
        for clean_class_label in self.classes:
            for pois_class_label in self.classes:
                ...
                for concat_number in range(len(class_path)):
                    ...
                    for h in range(IMG_SIZE//args.img_size):
                        for w in range(IMG_SIZE//args.img_size):
